...
let album1 = myAlbum("Irshad", "Rang-e-Mohabat");
let album2 = myAlbum("Ubad", "Roshan Andhera");
let album3 = myAlbum("Huzaifa", "Mausam-e-Dil");
...
let album4 = myAlbum2("Irshad", "Rang-e-Mohabat", 30);
let album5 = myAlbum2("Ubad", "Roshan Andhera", 55);
let album6 = myAlbum2("Huzaifa", "Mausam-e-Dil");
